                    ...
                    <Container>
                        ...
                        <Row>
                            <Col>
                                <div className="ball">
                                    <div>
                                        ...
                                        <svg width="69" height="69" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="34.5" cy="34.5" r="34.5" fill="#F1F5FF"/><path d="M43.54 18H26.83a.5.5 0 00-.5.5v.56a.5.5 0 00.5.5h16.71a.5.5 0 00.5-.5v-.56a.5.5 0 00-.5-.5zM43.54 31.25H26.83a.5.5 0 00-.5.5v.56a.5.5 0 00.5.5h16.71a.5.5 0 00.5-.5v-.56a.5.5 0 00-.5-.5zM43.77 19.56H26.58v11.69h17.19V19.56z" stroke="#4074F8" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M26.58 31.25v7.06a55.516 55.516 0 00.33 8 26.821 26.821 0 002.48 6.5h11.55a26.821 26.821 0 002.48-6.5c.302-2.655.413-5.329.33-8v-7.06M37.75 23.1H33v4.75h4.75V23.1z" stroke="#4074F8" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M26.56 37.1H24v-1.25l2.33-1.16M43.77 37.1h2.56v-1.25L44 34.69" stroke="#4074F8" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
                                    </div>
                            ...
                            <Col>
                                <div className="ball">
                                    <div>
                                        <svg width="69" height="69" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="34.5" cy="34.5" r="34.5" fill="#F1F5FF"/><path d="M54.018 33.074H15.457a.614.614 0 00-.614.614v2.284c0 .339.275.614.614.614h38.56c.34 0 .615-.275.615-.614v-2.285a.614.614 0 00-.614-.613z" stroke="#4074F8" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M38.556 29.586h-7.835a.614.614 0 00-.614.614v2.284c0 .34.275.614.614.614h7.835c.34 0 .614-.275.614-.614V30.2a.614.614 0 00-.614-.614z" stroke="#4074F8" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M37.095 19h-5.047a.614.614 0 00-.614.614v9.358c0 .339.274.614.614.614h5.047c.339 0 .614-.275.614-.614v-9.358a.614.614 0 00-.614-.614zM52.47 36.5H17.04a.614.614 0 00-.613.614v13.582c0 .34.275.614.614.614h35.43c.338 0 .613-.275.613-.614V37.114a.614.614 0 00-.614-.614z" stroke="#4074F8" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
                                    </div>
                                    <div className="bullet">
                            ...
                            <Col>
                                <div className="ball">
                                    <div>
                                        <svg width="69" height="69" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="34.5" cy="34.5" r="34.5" fill="#F1F5FF"/><path d="M23.173 23.102h24.228a.491.491 0 01.438.534v22.136a.49.49 0 01-.438.534H23.173M19 40.937V23.284" stroke="#4074F8" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M23.173 46.274c-2.305 0-4.173-2.263-4.173-5.08 0-2.819 1.868-5.113 4.173-5.113V17.99c-2.305 0-4.173 2.294-4.173 5.111M47.838 26.827h2.647a.491.491 0 01.438.534v22.114a.491.491 0 01-.438.534h-24.26M26.226 50.02a4.408 4.408 0 01-4.013-3.746M36.504 32.09l2.935-.62-3.938 5.604-2.466-3.352L29.3 38.43M39.439 31.47l.395 2.54" stroke="#4074F8" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
                                    </div>
                                    <div className="bullet">
